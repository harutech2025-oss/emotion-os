...
const QS = [
  ...
  { id:"I10", p:"최근 2주간, 참고 있던 감정이 어느 순간 말이나 행동으로 평소보다 강하게 드러난 적이 있었나요?", rcP:"지금 감정이 말이나 행동으로 평소보다 빠르게 드러날 것 같은 느낌인가요?", pq:"Q4", sq:"Q1", r1:"R3", leak:"출력단", bug:"MND-OUTPUTHEAT-01", bugL:"출력 과열 버그", patch:"Stop Signal", patchL:"출력 차단 신호 패치", mode:"평정 모드", modeD:"폭발 직전의 출력단을 진정시키고 반응 속도를 늦추는 운영 자세" },
  { id:"I11", p:"최근 2주간, 감정이 올라올 때 말의 속도나 톤이 평소보다 강해진 적이 있었나요?", rcP:"지금 감정이 말이나 행동으로 평소보다 빠르게 드러날 것 같은 느낌인가요?", pq:"Q4", sq:"Q1", r1:"R3", leak:"출력단", bug:"MND-OUTPUTHEAT-01", bugL:"출력 과열 버그", patch:"Stop Signal", patchL:"출력 차단 신호 패치", mode:"평정 모드", modeD:"폭발 직전의 출력단을 진정시키고 반응 속도를 늦추는 운영 자세" },
  { id:"I12", p:"최근 2주간, 감정을 표현한 뒤에도 개운함보다 피로감이 더 남았나요?", rcP:"지금 감정이 말이나 행동으로 평소보다 빠르게 드러날 것 같은 느낌인가요?", pq:"Q4", sq:"Q6", r1:"R3", leak:"출력단", bug:"MND-OUTPUTHEAT-01", bugL:"출력 과열 버그", patch:"Stop Signal", patchL:"출력 차단 신호 패치", mode:"평정 모드", modeD:"폭발 직전의 출력단을 진정시키고 반응 속도를 늦추는 운영 자세" },
  ...
  { id:"I16", p:"최근 2주간, SNS나 타인의 소식을 보고 내 상태가 갑자기 작아 보였나요?", rcP:"지금 외부 정보를 본 뒤 내 기준이 흔들리는 느낌인가요?", pq:"Q6", sq:"Q5", r1:"R1", leak:"처리단", bug:"MND-SELFDEVALUE-01", bugL:"자기비하 증폭 버그", patch:"Permission Reset", patchL:"허용 기준 복구 패치", mode:"최선 모드", modeD:"타인 기준이 아닌 과정 기준으로 비교 오염을 줄이는 운영 자세" },
  { id:"I17", p:"최근 2주간, 다른 사람의 성과나 속도를 본 뒤 내 하루가 작게 느껴진 적이 있었나요?", rcP:"지금 외부 정보를 본 뒤 내 기준이 흔들리는 느낌인가요?", pq:"Q6", sq:"Q1", r1:"R1", leak:"처리단", bug:"MND-FALSEPATCH-01", bugL:"가짜 패치 버그", patch:"Benchmark Filter", patchL:"기준 필터 패치", mode:"최선 모드", modeD:"타인 기준이 아닌 과정 기준으로 비교 오염을 줄이는 운영 자세" },
  { id:"I18", p:"최근 2주간, 다른 기준에 맞춰 내 하루를 다시 바꾸고 싶은 충동이 들었나요?", rcP:"지금 외부 정보를 본 뒤 내 기준이 흔들리는 느낌인가요?", pq:"Q6", sq:"Q7", r1:"R1", leak:"처리단", bug:"MND-SELFDEVALUE-01", bugL:"자기비하 증폭 버그", patch:"Permission Reset", patchL:"허용 기준 복구 패치", mode:"최선 모드", modeD:"타인 기준이 아닌 과정 기준으로 비교 오염을 줄이는 운영 자세" },
